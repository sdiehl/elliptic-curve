...
sect113r1 = Curve
  ...
  , affine = Affine
    { xA = BF 0x9d73616f35f4ab1407d73562c10f
    , yA = BF 0xa52830277958ee84d1315ed31886
    }
  }
...
sect113r2 = Curve
  ...
  , affine = Affine
    { xA = BF 0x1a57a6a7b26ca5ef52fcdb8164797
    , yA = BF 0xb3adc94ed1fe674c06e695baba1d
    }
  }
...
sect131r1 = Curve
  ...
  , affine = Affine
    { xA = BF 0x81baf91fdf9833c40f9c181343638399
    , yA = BF 0x78c6e7ea38c001f73c8134b1b4ef9e150
    }
  }
...
sect131r2 = Curve
  ...
  , affine = Affine
    { xA = BF 0x356dcd8f2f95031ad652d23951bb366a8
    , yA = BF 0x648f06d867940a5366d9e265de9eb240f
    }
  }
...
sect163k1 = Curve
  ...
  , affine = Affine
    { xA = BF 0x2fe13c0537bbc11acaa07d793de4e6d5e5c94eee8
    , yA = BF 0x289070fb05d38ff58321f2e800536d538ccdaa3d9
    }
  }
...
sect163r1 = Curve
  ...
  , affine = Affine
    { xA = BF 0x369979697ab43897789566789567f787a7876a654
    , yA = BF 0x435edb42efafb2989d51fefce3c80988f41ff883
    }
  }
...
sect163r2 = Curve
  ...
  , affine = Affine
    { xA = BF 0x3f0eba16286a2d57ea0991168d4994637e8343e36
    , yA = BF 0xd51fbc6c71a0094fa2cdd545b11c5c0c797324f1
    }
  }
...
sect193r1 = Curve
  ...
  , affine = Affine
    { xA = BF 0x1f481bc5f0ff84a74ad6cdf6fdef4bf6179625372d8c0c5e1
    , yA = BF 0x25e399f2903712ccf3ea9e3a1ad17fb0b3201b6af7ce1b05
    }
  }
...
sect193r2 = Curve
  ...
  , affine = Affine
    { xA = BF 0xd9b67d192e0367c803f39e1a7e82ca14a651350aae617e8f
    , yA = BF 0x1ce94335607c304ac29e7defbd9ca01f596f927224cdecf6c
    }
  }
...
sect233k1 = Curve
  ...
  , affine = Affine
    { xA = BF 0x17232ba853a7e731af129f22ff4149563a419c26bf50a4c9d6eefad6126
    , yA = BF 0x1db537dece819b7f70f555a67c427a8cd9bf18aeb9b56e0c11056fae6a3
    }
  }
...
sect233r1 = Curve
  ...
  , affine = Affine
    { xA = BF 0xfac9dfcbac8313bb2139f1bb755fef65bc391f8b36f8f8eb7371fd558b
    , yA = BF 0x1006a08a41903350678e58528bebf8a0beff867a7ca36716f7e01f81052
    }
  }
...
sect239k1 = Curve
  ...
  , affine = Affine
    { xA = BF 0x29a0b6a887a983e9730988a68727a8b2d126c44cc2cc7b2a6555193035dc
    , yA = BF 0x76310804f12e549bdb011c103089e73510acb275fc312a5dc6b76553f0ca
    }
  }
...
sect283k1 = Curve
  ...
  , affine = Affine
    { xA = BF 0x503213f78ca44883f1a3b8162f188e553cd265f23c1567a16876913b0c2ac2458492836
    , yA = BF 0x1ccda380f1c9e318d90f95d07e5426fe87e45c0e8184698e45962364e34116177dd2259
    }
  }
...
sect283r1 = Curve
  ...
  , affine = Affine
    { xA = BF 0x5f939258db7dd90e1934f8c70b0dfec2eed25b8557eac9c80e2e198f8cdbecd86b12053
    , yA = BF 0x3676854fe24141cb98fe6d4b20d02b4516ff702350eddb0826779c813f0df45be8112f4
    }
  }
...
sect409k1 = Curve
  ...
  , affine = Affine
    { xA = BF 0x60f05f658f49c1ad3ab1890f7184210efd0987e307c84c27accfb8f9f67cc2c460189eb5aaaa62ee222eb1b35540cfe9023746
    , yA = BF 0x1e369050b7c4e42acba1dacbf04299c3460782f918ea427e6325165e9ea10e3da5f6c42e9c55215aa9ca27a5863ec48d8e0286b
    }
  }
...
sect409r1 = Curve
  ...
  , affine = Affine
    { xA = BF 0x15d4860d088ddb3496b0c6064756260441cde4af1771d4db01ffe5b34e59703dc255a868a1180515603aeab60794e54bb7996a7
    , yA = BF 0x61b1cfab6be5f32bbfa78324ed106a7636b9c5a7bd198d0158aa4f5488d08f38514f1fdf4b4f40d2181b3681c364ba0273c706
    }
  }
...
sect571k1 = Curve
  ...
  , affine = Affine
    { xA = BF 0x26eb7a859923fbc82189631f8103fe4ac9ca2970012d5d46024804801841ca44370958493b205e647da304db4ceb08cbbd1ba39494776fb988b47174dca88c7e2945283a01c8972
    , yA = BF 0x349dc807f4fbf374f4aeade3bca95314dd58cec9f307a54ffc61efc006d8a2c9d4979c0ac44aea74fbebbb9f772aedcb620b01a7ba7af1b320430c8591984f601cd4c143ef1c7a3
    }
  }
...
sect571r1 = Curve
  ...
  , affine = Affine
    { xA = BF 0x303001d34b856296c16c0d40d3cd7750a93d1d2955fa80aa5f40fc8db7b2abdbde53950f4c0d293cdd711a35b67fb1499ae60038614f1394abfa3b4c850d927e1e7769c8eec2d19
    , yA = BF 0x37bf27342da639b6dccfffeb73d69d78c6c27a6009cbbca1980f8533921e8a684423e43bab08a576291af8f461bb2a8b3531d2f0485c19b16e2f1516e23dd3c1a4827af1b8ac15b
    }
  }
