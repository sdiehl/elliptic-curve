...
sect113r2 = Curve
  ...
  , parameters = Parameters
    ...
    , h = 0x2
    , n = 0x10000000000000108789b2496af93
    , p = 0x20000000000000000000000000201
    }
  }
...
sect131r2 = Curve
  ...
  , parameters = Parameters
    ...
    , h = 0x2
    , n = 0x400000000000000016954a233049ba98f
    , p = 0x80000000000000000000000000000010d
    }
  }
...
sect163r1 = Curve
  ...
  , parameters = Parameters
    ...
    , h = 0x2
    , n = 0x3ffffffffffffffffffff48aab689c29ca710279b
    , p = 0x800000000000000000000000000000000000000c9
    }
  }
...
sect193r1 = Curve
  ...
  , parameters = Parameters
    ...
    , h = 0x2
    , n = 0x1000000000000000000000000c7f34a778f443acc920eba49
...
sect193r2 = Curve
  ...
  , parameters = Parameters
    ...
    , h = 0x2
    , n = 0x10000000000000000000000015aab561b005413ccd4ee99d5
    , p = 0x2000000000000000000000000000000000000000000008001
    }
  }
