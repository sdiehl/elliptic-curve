module Curve.TwistedEdwards.Ed25519
  -- | Types
  ( Fp
  , P
  -- | Parameters
...
-- | Ed25519 curve is a twisted Edwards curve
instance TECurve Ed25519 Fp where
  a_ = const _a
  {-# INLINE a_ #-}
  d_ = const _d
  {-# INLINE d_ #-}
...
_g :: P
_g = A 0x216936d3cd6e53fec0a4e231fdd6dc5c692cc7609525a7b2c9562d608f25d51a
