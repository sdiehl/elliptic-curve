module Curve.ShortWeierstrass.BrainpoolP512R1
  -- | Types
  ( Fp
  , P
  -- | Parameters
...
-- | Field of Brainpool-P512R1 curve
...
-- | Brainpool-P512R1 curve is a short Weierstrass curve
instance SWCurve BrainpoolP512R1 Fp where
  a_ = const _a
  {-# INLINE a_ #-}
  b_ = const _b
  {-# INLINE b_ #-}
...
-- | Point of Brainpool-P512R1 curve
type P = SWPoint BrainpoolP512R1 Fp

-------------------------------------------------------------------------------
-- Parameters
-------------------------------------------------------------------------------

-- | Coefficient @A@ of Brainpool-P512R1 curve
_a :: Fp
...
-- | Coefficient @B@ of Brainpool-P512R1 curve
_b :: Fp
...
-- | Generator of Brainpool-P512R1 curve
_g :: P
_g = A
...
-- | Cofactor of Brainpool-P512R1 curve
_h :: Integer
_h = 1
{-# INLINE _h #-}

-- | Order of Brainpool-P512R1 curve
_n :: Integer
...
-- | Characteristic of Brainpool-P512R1 curve
_p :: Integer
