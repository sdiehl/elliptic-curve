module Curve.ShortWeierstrass.BrainpoolP384R1
  -- | Types
  ( Fp
  , P
  -- | Parameters
...
-- | Brainpool-P384R1 curve is a short Weierstrass curve
instance SWCurve BrainpoolP384R1 Fp where
  a_ = const _a
  {-# INLINE a_ #-}
  b_ = const _b
  {-# INLINE b_ #-}
...
type P = SWPoint BrainpoolP384R1 Fp
