module Curve.ShortWeierstrass.BN462T
  -- | Types
  ( Fp2
  , P
  -- | Parameters
...
import Curve.ShortWeierstrass.BN462 (Fp)
...
-- | BN462T curve is a short Weierstrass curve
instance SWCurve BN462T Fp2 where
  a_ = const _a
  {-# INLINE a_ #-}
  b_ = const _b
  {-# INLINE b_ #-}
