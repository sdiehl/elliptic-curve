...
instance SWCurve SECP384R1 Fq where
  ...
  _h _ = 1
  {-# INLINE _h #-}
  _q _ = 0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFF0000000000000000FFFFFFFF
  {-# INLINE _q #-}
  _r _ = 0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFC7634D81F4372DDF581A0DB248B0A77AECEC196ACCC52973
  {-# INLINE _r #-}
