module Curve.ShortWeierstrass.BrainpoolP320R1
  -- | Types
  ( Fp
  , P
  -- | Parameters
...
-- | Brainpool-P320R1 curve is a short Weierstrass curve
instance SWCurve BrainpoolP320R1 Fp where
  a_ = const _a
  {-# INLINE a_ #-}
  b_ = const _b
  {-# INLINE b_ #-}
...
type P = SWPoint BrainpoolP320R1 Fp
