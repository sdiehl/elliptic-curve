module Curve.ShortWeierstrass.BrainpoolP224T1
  -- | Types
  ( Fp
  , P
  -- | Parameters
...
-- | Brainpool-P224T1 curve is a short Weierstrass curve
instance SWCurve BrainpoolP224T1 Fp where
  a_ = const _a
  {-# INLINE a_ #-}
  b_ = const _b
  {-# INLINE b_ #-}
...
type P = SWPoint BrainpoolP224T1 Fp
