module Curve.ShortWeierstrass.BrainpoolP192R1
  -- | Types
  ( Fp
  , P
  -- | Parameters
...
-- | Brainpool-P192R1 curve is a short Weierstrass curve
instance SWCurve BrainpoolP192R1 Fp where
  a_ = const _a
  {-# INLINE a_ #-}
  b_ = const _b
  {-# INLINE b_ #-}
...
type P = SWPoint BrainpoolP192R1 Fp
