module Curve.ShortWeierstrass.BrainpoolP224R1
  -- | Types
  ( Fp
  , P
  -- | Parameters
...
-- | Brainpool-P224R1 curve is a short Weierstrass curve
instance SWCurve BrainpoolP224R1 Fp where
  a_ = const _a
  {-# INLINE a_ #-}
  b_ = const _b
  {-# INLINE b_ #-}
...
type P = SWPoint BrainpoolP224R1 Fp
