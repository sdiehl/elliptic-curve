module Curve.ShortWeierstrass.BLS48_581T
  -- | Types
  ( Fp8
  , P
  -- | Parameters
...
import Curve.ShortWeierstrass.BLS48_581 (Fp)
...
-- | BLS48-581T curve is a short Weierstrass curve
instance SWCurve BLS48_581T Fp8 where
  a_ = const _a
  {-# INLINE a_ #-}
  b_ = const _b
  {-# INLINE b_ #-}
...
type P = SWPoint BLS48_581T Fp8

-------------------------------------------------------------------------------
-- Parameters
-------------------------------------------------------------------------------

-- | Coefficient @A@ of BLS48-581T curve
_a :: Fp8
_a = 0
{-# INLINE _a #-}

-- | Coefficient @B@ of BLS48-581T curve
_b :: Fp8
_b = -1 / fromList [0, 1]
{-# INLINE _b #-}

-- | Generator of BLS48-581T curve
_g :: P
_g = A
  ( fromList
   [ fromList
    [ fromList
     [ 0x5d615d9a7871e4a38237fa45a2775debabbefc70344dbccb7de64db3a2ef156c46ff79baad1a8c42281a63ca0612f400503004d80491f510317b79766322154dec34fd0b4ace8bfab
    ...
    , fromList
     [ 0x1fccc70198f1334e1b2ea1853ad83bc73a8a6ca9ae237ca7a6d6957ccbab5ab6860161c1dbd19242ffae766f0d2a6d55f028cbdfbb879d5fea8ef4cded6b3f0b46488156ca55a3e6a
   ...
   , fromList
    ...
    , fromList
     [ 0xb9b7951c6061ee3f0197a498908aee660dea41b39d13852b6db908ba2c0b7a449cef11f293b13ced0fd0caa5efcf3432aad1cbe4324c22d63334b5b0e205c3354e41607e60750e057
  ...
  ( fromList
   [ fromList
    [ fromList
     [ 0xeb53356c375b5dfa497216452f3024b918b4238059a577e6f3b39ebfc435faab0906235afa27748d90f7336d8ae5163c1599abf77eea6d659045012ab12c0ff323edd3fe4d2d7971
   ...
   , fromList
    [ fromList
     [ 0xd209d5a223a9c46916503fa5a88325a2554dc541b43dd93b5a959805f1129857ed85c77fa238cdce8a1e2ca4e512b64f59f430135945d137b08857fdddfcf7a43f47831f982e50137
...
-- | Characteristic of BLS48-581T curve
_p :: Integer
