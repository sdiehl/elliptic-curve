module Curve.ShortWeierstrass.BrainpoolP256R1
  -- | Types
  ( Fp
  , P
  -- | Parameters
...
-- | Brainpool-P256R1 curve is a short Weierstrass curve
instance SWCurve BrainpoolP256R1 Fp where
  a_ = const _a
  {-# INLINE a_ #-}
  b_ = const _b
  {-# INLINE b_ #-}
...
type P = SWPoint BrainpoolP256R1 Fp
