module Curve.ShortWeierstrass.ANSSIFRP256V1
  -- | Types
  ( Fp
  , P
  -- | Parameters
...
-- | ANSSI-FRP256V1 curve is a short Weierstrass curve
instance SWCurve ANSSIFRP256V1 Fp where
  a_ = const _a
  {-# INLINE a_ #-}
  b_ = const _b
  {-# INLINE b_ #-}
...
type P = SWPoint ANSSIFRP256V1 Fp
