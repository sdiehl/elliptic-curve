...
testWeierstrass = testGroup "Weierstrass"
  ...
  , test   "ANSSIFRP256V1"   ANSSIFRP256V1._g   ANSSIFRP256V1._h   ANSSIFRP256V1._n   ANSSIFRP256V1._p
  , test        "BLS12381"        BLS12381._g        BLS12381._h        BLS12381._n        BLS12381._p
  , test       "BLS12381T"       BLS12381T._g       BLS12381T._h       BLS12381T._n       BLS12381T._p
  , test        "BLS48581"        BLS48581._g        BLS48581._h        BLS48581._n        BLS48581._p
  , test       "BLS48581T"       BLS48581T._g       BLS48581T._h       BLS48581T._n       BLS48581T._p
  ...
  , test "BrainpoolP160R1" BrainpoolP160R1._g BrainpoolP160R1._h BrainpoolP160R1._n BrainpoolP160R1._p
  , test "BrainpoolP160T1" BrainpoolP160T1._g BrainpoolP160T1._h BrainpoolP160T1._n BrainpoolP160T1._p
  , test "BrainpoolP192R1" BrainpoolP192R1._g BrainpoolP192R1._h BrainpoolP192R1._n BrainpoolP192R1._p
  , test "BrainpoolP192T1" BrainpoolP192T1._g BrainpoolP192T1._h BrainpoolP192T1._n BrainpoolP192T1._p
  , test "BrainpoolP224R1" BrainpoolP224R1._g BrainpoolP224R1._h BrainpoolP224R1._n BrainpoolP224R1._p
  , test "BrainpoolP224T1" BrainpoolP224T1._g BrainpoolP224T1._h BrainpoolP224T1._n BrainpoolP224T1._p
  , test "BrainpoolP256R1" BrainpoolP256R1._g BrainpoolP256R1._h BrainpoolP256R1._n BrainpoolP256R1._p
  , test "BrainpoolP256T1" BrainpoolP256T1._g BrainpoolP256T1._h BrainpoolP256T1._n BrainpoolP256T1._p
  , test "BrainpoolP320R1" BrainpoolP320R1._g BrainpoolP320R1._h BrainpoolP320R1._n BrainpoolP320R1._p
  , test "BrainpoolP320T1" BrainpoolP320T1._g BrainpoolP320T1._h BrainpoolP320T1._n BrainpoolP320T1._p
  , test "BrainpoolP384R1" BrainpoolP384R1._g BrainpoolP384R1._h BrainpoolP384R1._n BrainpoolP384R1._p
  , test "BrainpoolP384T1" BrainpoolP384T1._g BrainpoolP384T1._h BrainpoolP384T1._n BrainpoolP384T1._p
  , test "BrainpoolP512R1" BrainpoolP512R1._g BrainpoolP512R1._h BrainpoolP512R1._n BrainpoolP512R1._p
  , test "BrainpoolP512T1" BrainpoolP512T1._g BrainpoolP512T1._h BrainpoolP512T1._n BrainpoolP512T1._p
